...
(new-object System.Net.WebClient).DownloadFile('http://web.archive.org/web/20200914203650/https://ffmpeg.zeranoe.com/builds/win64/dev/ffmpeg-20190716-806ac7d-win64-dev.zip', $devZipPath);
Expand-Archive $devZipPath -DestinationPath $tempPath -Force

(new-object System.Net.WebClient).DownloadFile('http://web.archive.org/web/20200914203650/https://ffmpeg.zeranoe.com/builds/win64/shared/ffmpeg-20190716-806ac7d-win64-shared.zip', $binZipPath);
